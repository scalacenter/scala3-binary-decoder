...
class BinaryDecoderStats extends BinaryDecoderSuite:
  ...
  test("scala3-compiler:3.3.1"):
    ...
    decoder.assertDecodeAll(
      ...
      expectedVariables = ExpectedCount(137875, ambiguous = 4905, notFound = 2634)
    )
  ...
  test("scala3-compiler:3.0.2"):
    ...
    decoder.assertDecodeAll(
      ...
      expectedVariables = ExpectedCount(119391, ambiguous = 4306, notFound = 2320)
    )
  ...
  test("org.tpolecat:doobie-h2_3:0.13.4"):
    ...
    decoder.assertDecodeAll(
      ...
      expectedVariables = ExpectedCount(195, notFound = 52)
    )
  ...
  test("company.jap:fields-core_3:0.4.16"):
    ...
    decoder.assertDecodeAll(
      ...
      expectedVariables = ExpectedCount(4785, ambiguous = 58, notFound = 38)
    )
  ...
  test("com.github.simy4.xpath:xpath-to-xml-scala_3:2.3.7"):
    ...
    decoder.assertDecodeAll(
      ...
      expectedVariables = ExpectedCount(291, ambiguous = 3, notFound = 6)
    )
  ...
  test("eu.ostrzyciel.jelly:jelly-grpc_3:0.5.3"):
    ...
    decoder.assertDecodeAll(
      ...
      expectedVariables = ExpectedCount(477, ambiguous = 3, notFound = 2)
    )
  ...
  test("com.devsisters:zio-agones_3:0.1.0"):
    ...
    decoder.assertDecodeAll(
      ...
      expectedVariables = ExpectedCount(3845, ambiguous = 17, notFound = 31, throwables = 46)
    )
